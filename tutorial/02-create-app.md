...
Abra la interfaz de línea de comandos (CLI), vaya a un directorio donde tenga derechos para crear archivos y ejecute el siguiente comando para crear una nueva aplicación PHP.

```Shell
laravel new graph-tutorial
```

Laravel crea un nuevo directorio al `graph-tutorial` que se llama y scaffolding una aplicación PHP. Navegue a este nuevo directorio y escriba el siguiente comando para iniciar un servidor Web local.
...
Empiece por crear el diseño global para la aplicación. Cree un nuevo archivo en el `./resources/views` directorio denominado `layout.blade.php` y agregue el siguiente código.
...
Ahora, actualice la página predeterminada. Abra el `./resources/views/welcome.blade.php` archivo y reemplace el contenido por lo siguiente.
...
Actualice la clase `Controller` base en `./app/Http/Controllers/Controller.php` agregando la siguiente función a la clase.
...
A continuación, agregue un controlador para la Página principal. Cree un nuevo archivo en el `./app/Http/Controllers` directorio denominado `HomeController.php` y agregue el siguiente código.
...
Por último, actualice la ruta `./routes/web.php` en para que use el nuevo controlador. Reemplace todo el contenido de este archivo por lo siguiente.
